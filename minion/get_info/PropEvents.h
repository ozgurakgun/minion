...
VAR_EVENT(setExpl, WRITE_EVENT)
VAR_EVENT(getExpl, READ_EVENT)
VAR_EVENT(getDepth, READ_EVENT)
...
PROP_EVENT(WhyTLessConstant)
PROP_EVENT(WhyTGreaterConstant)
PROP_EVENT(WhyTWatchlessPrunLeft)
PROP_EVENT(WhyTWatchlessPrunRight)
PROP_EVENT(WhyTNegOfPostedCon)
PROP_EVENT(WhyTDisjunctionPrun)
PROP_EVENT(WhyTBecauseOfAssignmentPrun)
PROP_EVENT(WhyTMHAV)
PROP_EVENT(WhyTAssgOrPrun)
PROP_EVENT(WhyTBecauseOfPruningsAssignment)
PROP_EVENT(WhyTDecisionAssg)
PROP_EVENT(WhyTNoReasonPrun)
PROP_EVENT(WhyTNoReasonAssg)
PROP_EVENT(WhyTAMOV)
