/* Minion Constraint Solver
   ...
   $Id: build_helper.h 701 2007-10-09 14:12:05Z azumanga $
*/
...
{ \
  ...
  { \
	...
	{ \
	  BoolVarRef reifyVar = stateObj->varCon().getBooleanContainer().get_var_num(b.reify_var.pos); \
	  BoolVarRef dummyVar; \
	...
	{ \
	  BoolVarRef reifyVar; \
	  if(b.reified) \
	    reifyVar = stateObj->varCon().getBooleanContainer().get_var_num(b.reify_var.pos); \
